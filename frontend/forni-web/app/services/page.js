...
const Services = () => {
  ...
  const filteredAndSortedServices = React.useMemo(() => {
    ...
    if (searchQuery.trim()) {
      ...
      filtered = services.filter(services => 
        services.name.toLowerCase().includes(query) ||
        services.specification?.toLowerCase().includes(query)
      );
    }
  ...
  const handleGetQuotation = (serviceName) => {
    // You can customize this to open a modal, redirect to a form, etc.
    const subject = `Quotation Request - ${serviceName}`;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Discover our comprehensive range of services we provide.
          </p>
        </div>
          ...
          <div className="text-center py-12">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
              ...
              <p className="text-gray-600">
                {searchQuery.trim() 
                  ? `No service(s) match your search "${searchQuery}"`
      ...
      <div className="p-4">
        ...
        <div className="mt-12 bg-orange-50 rounded-lg p-8 text-center">
          ...
          <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
            Can't find exactly what you're looking for? Our team is willing to schedule your required services.
          </p>
          <Link
